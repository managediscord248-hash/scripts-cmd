...
# ==========================================================
# 👑 KINGCLOUD • TERMIUS 👑
# NEON INDIAN TRICOLOR EDITION • TAILSCALE + SSH • NO SYSTEMD
# ==========================================================
...
echo -e "${WHITE}"
echo "                ━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "${GREEN}                TERMIUS • SSH • TAILSCALE${RESET}"
echo -e "${NAVY}                NO SYSTEMD • NEON PANEL${RESET}"
echo -e "${SAFFRON}                ━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo

echo -e "${CYAN}               👑 KINGCLOUD • TERMIUS 👑${RESET}"
echo -e "${GRAY}            ─────── NEON TRICOLOR ───────${RESET}"
echo
...
echo "                    T E R M I U S"
echo -e "${RESET}"
echo -e "${WHITE}                NEON TRICOLOR PANEL${RESET}"
...
echo
echo -e "${SAFFRON}👑 KINGCLOUD${WHITE} • ${GREEN}TERMIUS${WHITE} • ${NAVY}NEON TRICOLOR EDITION${RESET} 👑"
echo
